...
const footer ='https://res.cloudinary.com/duz6kitlg/image/upload/v1751829160/banner_dental_czv1gn.png'
...
const Footer = () => {
  ...
  {/* Background image */}
  <div className="absolute inset-0 bg-cover bg-center z-0" style={{ backgroundImage: `url(${footer})` }}></div>
  ...
  <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-left md:text-left">
    ...
    <div>
      <img src={logo} className='w-30 cursor-pointer p-2 rounded footer-img mb-2'/>
    </div>
